...
namespace SurfLocalShop.Migrations.StoreConfiguration
{
    ...
    using System;
    internal sealed class StoreConfiguration : DbMigrationsConfiguration<SurfLocalShop.DAL.StoreContext>
    {
        ...
        protected override void Seed(SurfLocalShop.DAL.StoreContext context)
        {
